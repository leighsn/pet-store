...
class CatsControllerTest < ActionController::TestCase
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post :create, cat: { age: @cat.age, breed: @cat.breed, color: @cat.color, image: @cat.image, name: @cat.name }
    end
  ...
  test "should update cat" do
    patch :update, id: @cat, cat: { age: @cat.age, breed: @cat.breed, color: @cat.color, image: @cat.image, name: @cat.name }
    assert_redirected_to cat_path(assigns(:cat))
  end
